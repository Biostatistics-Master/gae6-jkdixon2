...
This result is supported by multiple comparisons and further defined by the contrast of uninfected versus infected pea aphids (@tbl-Planned and @tbl-Tukey).
...
```{r}
#| label: tbl-Tukey
#| tbl-cap: "All pair-wise comparisons of means with the Tukey correction to protect the experiment-wize error rate at 0.05."
